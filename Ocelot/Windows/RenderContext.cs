...
public class RenderContext(OcelotPlugin plugin, IModule? module = null, PctDrawList? drawList = null)
{
    public readonly OcelotPlugin Plugin = plugin;

    public IModule? Module { get; private set; } = module;

    public readonly PctDrawList Pictomancy = drawList ?? PictoService.GetDrawList();
    ...
    {
        return new RenderContext(Plugin, module, Pictomancy);
    }
