...
{
    public static void Info(string messageTemplate, params object[] values) => Svc.Log.Info($"[Ocelot] {messageTemplate}", values);
    ...
    public static void Fatal(string messageTemplate, params object[] values) => Svc.Log.Fatal($"[Ocelot] {messageTemplate}", values);
    ...
    public static void Error(string messageTemplate, params object[] values) => Svc.Log.Error($"[Ocelot] {messageTemplate}", values);
    ...
    public static void Warning(string messageTemplate, params object[] values) => Svc.Log.Warning($"[Ocelot] {messageTemplate}", values);
    ...
    public static void Debug(string messageTemplate, params object[] values) => Svc.Log.Debug($"[Ocelot] {messageTemplate}", values);
    ...
    public static void Verbose(string messageTemplate, params object[] values) => Svc.Log.Verbose($"[Ocelot] {messageTemplate}", values);
