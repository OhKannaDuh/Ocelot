...
public class InteractChain(IChainFactory chains, ITargetManager targets, ICondition conditions, ILogger<InteractChain> logger) : ChainRecipe<Func<IGameObject?>>(chains)
{
